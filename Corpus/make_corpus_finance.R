...
# Macro
# Macro
finance1 <- from_xml_to_df("Corpus_Econlit/finance1")
finance2 <- from_xml_to_df("Corpus_Econlit/finance2")
finance3 <- from_xml_to_df("Corpus_Econlit/finance3")
finance4 <- from_xml_to_df("Corpus_Econlit/finance4")
finance5 <- from_xml_to_df("Corpus_Econlit/finance5")
finance6 <- from_xml_to_df("Corpus_Econlit/finance6")

dt_JEL_Articles <- rbind(finance1, finance2, finance3, finance4, finance5, finance6)
rm(finance1, finance2, finance3, finance4, finance5, finance6)
...
saveRDS(dt_JEL_Articles, file = "Corpus_Econlit/dt_JEL_Finance_Articles.rds")
# saveRDS(dt_Old_JEL_Articles, file = "Corpus_Econlit/dt_Old_JEL_Articles_Finance.rds")
...
revues <- dbGetQuery(ESH, "SELECT Code_Revue, Revue, Code_Discipline FROM OST_Expanded_SciHum.Revues;") %>% data.table()
revues <- revues %>%
  mutate(Code_Discipline = replace(Code_Discipline, Code_Discipline >= 101 & Code_Discipline <= 109, 101)) %>%
  data.table()
...
saveRDS(JEL_matched_corpus_authors, file = "Corpus_Econlit_Matched_WoS/JEL_Finance_matched_corpus_authors.rds")
...
saveRDS(JEL_matched_corpus_nodes, file = "Corpus_Econlit_Matched_WoS/JEL_Finance_matched_corpus_nodes.rds")
...
saveRDS(JEL_matched_corpus_edges, file = "Corpus_Econlit_Matched_WoS/JEL_Finance_matched_corpus_edges.rds")
...
saveRDS(JEL_matched_corpus_references, file = "Corpus_Econlit_Matched_WoS/JEL_Finance_matched_corpus_references_info.rds")
