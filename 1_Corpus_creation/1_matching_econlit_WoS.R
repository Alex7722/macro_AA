...
#################### 1.1 Prepping WoS ####################
# Articles
all_art <- readRDS(here(data_path, "macro_AA","OST_generic_data", "all_art.RDS"))
# Authors
...
# Issues
issueID <- fread(here(data_path, "macro_AA","OST_generic_data", "revueID.csv"), quote = "") %>% data.table()
