...
source(path.expand("~/macro_AA/Static_Network_Analysis/functions_for_network_analysis.R"))
...
png(path.expand(paste0(picture_path,"heatmap_coupling_",start_date[i],"-",end_date[i],".png")), width = 1200, height = 1000)
grid.newpage()
...
png(path.expand(paste0(picture_path,"heatmap_authors_coupling_",start_date[i],"-",end_date[i],".png")), width = 1200, height = 1000)
grid.newpage()
print(heatmap$heatmap, vp = viewport(x = 0.4, y = 0.5, width = 0.75, height = 1.0))
print(heatmap$dendrogram, vp = viewport(x = 0.87, y = 0.5, width = 0.2, height = 0.9))
dev.off()
...
png(path.expand(paste0(picture_path,"heatmap_cocit_",start_date[i],"-",end_date[i],".png")), width = 1200, height = 1000)
grid.newpage()
print(heatmap$heatmap, vp = viewport(x = 0.4, y = 0.5, width = 0.75, height = 1.0))
print(heatmap$dendrogram, vp = viewport(x = 0.87, y = 0.5, width = 0.2, height = 0.9))
dev.off()
