...
knitr::opts_chunk$set(message = FALSE, warning = FALSE, echo = TRUE, cache=FALSE, fig.path = "/home/aurelien/macro_AA/Static_Network_Analysis/Pictures/", dev = "png")
...
i = 9 # choosing the period to study
...
include_graphics(paste0(picture_path,"graph_coupling_",dates[i],"-",dates[i+1],".png"))
```
...
TF_IDF <- readRDS(paste0(graph_data_path,"tf-idf_coupling_",dates[i],"-",dates[i+1],".rds"))
...
graph_coupling_community <- readRDS(paste0(graph_data_path,"graph_coupling_community_",dates[i],"-",dates[i+1],".rds"))
...
ggraph(graph_coupling_community, "manual", x = x, y = y) + 
  ...
  theme_void() +
  ggsave(paste0(picture_path,"graph_coupling_community_",dates[i],"-",dates[i+1],".png"), width=20, height=20, units = "cm")
...
png(paste0(picture_path,"heatmap_coupling_",dates[i],"-",dates[i+1],".png"), width = 1200, height = 1000)
grid.newpage()
...
include_graphics(paste0(picture_path,"heatmap_coupling_",dates[i],"-",dates[i+1],".png"))
```
...
plot_graph_journal <- ggraph(graph_journal, "manual", x = x, y = y) + 
  ...
  #scale_size_continuous(range = c(1,4)) +
  theme_void() +
  ggsave(paste0(picture_path,"graph_revue",dates[i],"-",dates[i+1],".png"), width=30, height=30, units = "cm")

include_graphics(paste0(picture_path,"graph_revue",dates[i],"-",dates[i+1],".png"))
```
...
include_graphics(paste0(picture_path,"graph_authors_coupling_",dates[i],"-",dates[i+1],".png"))
```
...
graph_authors_coupling_community <- readRDS( paste0(graph_data_path,"graph_authors_coupling_community_",dates[i],"-",dates[i+1],".rds"))
...
plot_graph_authors_coupling_community <- ggraph(graph_authors_coupling_community, "manual", x = x, y = y) + 
  ...
  #scale_size_continuous(range = c(1,4)) +
  theme_void() +
  ggsave(paste0(picture_path,"graph_authors_coupling_community_",dates[i],"-",dates[i+1],".png"), width=25, height=25, units = "cm")

include_graphics(paste0(picture_path,"graph_authors_coupling_community_",dates[i],"-",dates[i+1],".png"))
```
...
TF_IDF_authors <- readRDS(paste0(graph_data_path,"tf-idf_authors_coupling_",dates[i],"-",dates[i+1],".rds"))
...
include_graphics(paste0(picture_path,"graph_institutions_coupling_",dates[i],"-",dates[i+1],".png"))
}
...
include_graphics(paste0(picture_path,"graph_cocit",dates[i],"-",dates[i+1],".png"))
```
...
# loading the graph if necessary
graph_cocit_community <- readRDS(paste0(graph_data_path,"graph_cocit_community_",dates[i],"-",dates[i+1],".rds"))
...
ggraph(graph_cocit_community, "manual", x = x, y = y) + 
  ...
  #scale_size_continuous(range = c(1,4)) +
  theme_void() +
    ggsave(paste0(picture_path,"graph_cocit_community_",dates[i],"-",dates[i+1],".png"), width=20, height=20, units = "cm")
...
include_graphics(paste0(picture_path,"graph_coauthorship_",dates[i],"-",dates[i+1],".png"))
...
include_graphics(paste0(picture_path,"graph_co-authorship_institutions_",dates[i],"-",dates[i+1],".png"))
}
```
...
nodes_cocit <- merge(nodes_cocit, edges_JEL[between(Annee_Bibliographique, dates[i],dates[i+1]) & New_id2 %in% nodes_cocit$Id, c("New_id2","ID_Art","ItemID_Ref")], by.x = "Id", by.y = "New_id2") 
...
# merging the cocit nodes with the papers which cite them
nodes_authors <- merge(nodes_authors, authors_JEL[between(Annee_Bibliographique, dates[i],dates[i+1]) & Nom %in% nodes_authors$Id, c("Nom","ID_Art")], by.x = "Id", by.y = "Nom") 
