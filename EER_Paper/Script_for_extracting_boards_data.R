...
# Cleaning countries
wrong_country <- c("Beigium","Beleium","Belgiui","Cambridge","Czechosiovakia",
...
right_country <- c("Belgium","Belgium","Belgium","UK","Czechoslovakia",
                   "UK","UK","UK","UK", "Ireland",
...
wrong_names <- c("VONWEISZÄCKER-CC","VONWEIZSACKER-CC","VONWEIZSAECKER-CC","ZIMMERMANN-K$",
...
right_names <- c("VONWEISZACKER-CC","VONWEISZACKER-CC","VONWEISZACKER-CC","ZIMMERMANN-KF",
