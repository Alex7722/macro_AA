...
topic_diff <- readRDS(here(eer_data, 
                           "3_Topic_modelling",
                           "topic_model_1-50_topics_diff.rds"))

topics <- readRDS(here(eer_data, 
                           "3_Topic_modelling",
                           "topic_model_1-50_gamma_values.rds")) %>%
  filter(gamma > 0.1) %>%
...
top_terms <- readRDS(here(eer_data, 
                          "3_Topic_modelling",
                          "topic_model_1-50_top_terms.rds")) %>%
...
```{r}
knitr::include_graphics(paste0(here::here(), "/EER_Paper/Pictures/mean_diff_plot1-50.png"))
```
