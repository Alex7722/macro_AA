...
## final table
countries_table <- countries_table[order(window,new_Id_com,-share_of_country_occurence),.(window,new_Id_com,share_of_country_occurence)] %>% unique()
countries_table <- countries_table[,table_name:="Most_occurring_countries"] %>% rename("Share of Occurence" = share_of_country_occurence)
countries_table[,`Share of Occurence`:=paste0(format(round(`Share of Occurence`,2), 2)," %")]
...
## final table
institutions_table <- institutions_table[order(window,new_Id_com,-share_of_institutions_occurence),.(window,new_Id_com,share_of_institutions_occurence)] %>% unique()
institutions_table <- institutions_table[,table_name:="Most_occurring_institutions"] %>% rename("Share of Occurence" = share_of_institutions_occurence)
institutions_table[,`Share of Occurence`:=paste0(format(round(`Share of Occurence`,2), 2)," %")]
...
master_table_info_com <- rbind(authors_table, institutions_table, countries_table, most_cited_refs_info, tf_idf_table_final, com_origin, com_future, most_cited_from_com_table, most_cited_to_com_table, fill=TRUE)
