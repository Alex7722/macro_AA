...
This project was made possible by the generous support of the [History of Economics Society New Initiatives Fund](https://historyofeconomics.org/about-the-society/new-initiatives/). [Aurélien Goutsmedt](https://aurelien-goutsmedt.com) and [Alexandre Truc](https://sites.google.com/view/alexandre-truc/home-and-contact) have built the database and produced all the quantitative analyses. Philippe Boissonneault (Université de Sherbrooke) with the support of the [Plateforme en humanités numériques](https://www.usherbrooke.ca/flsh/recherche/centres-groupes-et-equipes-de-recherche/phun) has programmed the web application.

We would like to thank those who have given us useful feedback at different steps of the project: Béatrice Cherrier, François Claveau, Pedro Garcia Duarte, Romain Plassard, Matthieu Renault, Aurélien Saïdi, and Francesco Sergi, as well as the participants of the ESHET, HES and AIHPE sessions where we have presented the platform.
